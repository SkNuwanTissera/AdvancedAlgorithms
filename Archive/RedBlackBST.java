...
//        RedBlackBST<Long, Integer> st = new RedBlackBST<>();
    ...
    private static void doSplayInsert(RedBlackBST<Long, Integer> st, List<Long> dataset, String dataSetName, String fileName) {
    	long startTime = System.nanoTime();
    	Integer constantValue = 0;
    	
		System.out.println("RedBlackBST | Insert | " + dataSetName + " | " + fileName + " | Started ");
    	for(Long dataItem:dataset) {
    		st.put(dataItem, constantValue);
    	}
    	System.out.println("RedBlackBST | Insert | " + dataSetName + " | " + fileName + " | Ended | Duration : " + (System.nanoTime()-startTime)/1000);
    
    }
    
    private static void doSplaySearch(RedBlackBST<Long, Integer> st, List<Long> dataset, String dataSetName, String fileName) {
    	long startTime = System.nanoTime();
    	System.out.println("RedBlackBST | Search | " + dataSetName + " | " + fileName + " | Started");
    	for(Long dataItem:dataset) {
    		st.get(dataItem);
    	}
    	System.out.println("RedBlackBST | Search | " + dataSetName + " | " + fileName + " | Ended | Duration : " + (System.nanoTime()-startTime)/1000);
    
    }
    
    private static void doSplayDelete(RedBlackBST<Long, Integer> st, List<Long> dataset, String dataSetName, String fileName) {
    	long startTime = System.nanoTime();
    	System.out.println("RedBlackBST | Delete | " + dataSetName + " | " + fileName + " | Started");
    	for(Long dataItem:dataset) {
    		st.delete(dataItem);
    	}
    	System.out.println("RedBlackBST | Delete | " + dataSetName + " | " + fileName + " | Ended | Duration : " + (System.nanoTime()-startTime)/1000);
